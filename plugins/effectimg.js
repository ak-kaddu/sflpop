...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'txttoimg', fromMe: true, desc: EFFECT_DESC}, (async (message, match) => {    
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by: Ask Your Mom'})
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by: Ask Your Mom'})
    ...
    Asena.addCommand({pattern: 'txttoimg', fromMe: false, desc: EFFECT_DESC}, (async (message, match) => {    
