...
if (con.LANG === 'TR') {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'chutiya', fromMe: true, desc: TRGAY}, (async (message, match) => {
            ...
            await message.client.sendMessage(
                message.jid, 
                fs.readFileSync("/root/WhatsAsenaDuplicated/media/gif/carry.mp4"),
                MessageType.video, 
        ...
        Asena.addCommand({pattern: 'chutiya', fromMe: false, desc: TRGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'chutiya', fromMe: true, desc: HIGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'chutiya', fromMe: false, desc: HIGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'chutiya', fromMe: true, desc: AZGAY}, (async (message, match) => {
        ...
        Asena.addCommand({pattern: 'chutiya', fromMe: false, desc: AZGAY}, (async (message, match) => {
    ...
    if (con.WORKTYPE === 'private') {
        ...
        Asena.addCommand({pattern: 'chutiya', fromMe: true, desc: ENGAY}, (async (message, match) => {

            if (message.reply_message === false) return await message.client.sendMessage(message.jid, ENREP, MessageType.text);

            await message.client.sendMessage(message.jid, '*Calculating* ' + '@' + message.reply_message.jid.split('@')[0] + '’s *Chutiya meter.. 🏳️‍🤡*', MessageType.text, {
                quotedMessage: message.reply_message.data, contextInfo: {mentionedJid: [message.reply_message.jid.replace('c.us', 's.whatsapp.net')]}
            ...
            await message.client.sendMessage(
                ...
                fs.readFileSync("/root/WhatsAsenaDuplicated/media/gif/carry.mp4"),
                MessageType.video, 
                { mimetype: Mimetype.gif, caption: `*Chutiya meter Calculated!* 🏳️‍🤡\n*Result:* ${r_text[i]}` }
            )
        }));
    }
    else if (con.WORKTYPE === 'public') {

        Asena.addCommand({pattern: 'chutiya', fromMe: false, desc: ENGAY}, (async (message, match) => {
